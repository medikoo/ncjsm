...
module.exports = function (t, a) {
	...
	a(resolver('/project/node_modules/outer', 'outer3').value,
		'/project/node_modules/outer3/index.js');
	a(resolver('/project/node_modules/outer', 'project/foo').value, null);
	a(resolver('/project/node_modules/outer', 'nested/elo').value,
		'/project/node_modules/outer/node_modules/nested/elo.js');
	a(resolver('/project/node_modules/outer/node_modules/nested', 'project/foo').value, null);
	a(resolver('/project/node_modules/outer/node_modules/nested', 'outer').value,
		'/project/node_modules/outer/raz.js');
	a(resolver('/project/node_modules/outer/node_modules/nested', 'outer/boo').value,
		'/project/node_modules/outer/boo.js');
	a(resolver('/project/node_modules/outer/node_modules/nested', 'outer3').value,
		'/project/node_modules/outer3/index.js');
};
