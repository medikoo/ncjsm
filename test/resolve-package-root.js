...
module.exports = function (t, a, d) {
	deferred(
		t(playgroundDir)(function (value) { a(value, playgroundDir, "node_modules"); }),
		t(resolve(playgroundDir, 'otherdir'))(function (value) { a(value, playgroundDir, "Empty"); }),
		...
		t(resolve(playgroundDir, 'node_modules/outer3'))(function (value) { a(value, playgroundDir,
			"In node_modules"); })
	).done(function () { d(); }, d);
};
